...
<html lang="en">
  ...
  <div class="site-wrap">
    <div class="site-mobile-menu" style="margin:30px;">
    ...
    <header class="site-navbar fixed" role="banner">
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-4 site-logo">
            <a href="/" > <img src="{{ asset($setting->site_logo) }}" class="img-fluid" alt="" height="100" width="120"> </a>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-12 text-center">
            <p>
              {{ $setting->copyright }} | Zigpost <!-- <i class="icon-heart text-danger" aria-hidden="true"></i> -->
              <div class="mb-0">Developed By <a href="https://nilestack.com">Nilestack Technologies Ltd. </a></div>
            </p>
          </div>
        </div>
      </div>
